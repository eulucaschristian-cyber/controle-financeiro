export const CATEGORIES = {
  ...
  juros: { label: "Juros", emoji: "💸", color: "bg-red-100 text-red-700" },
  saude: { label: "Saúde", emoji: "💊", color: "bg-rose-100 text-rose-700" },
  educacao: { label: "Educação", emoji: "📚", color: "bg-cyan-100 text-cyan-700" },
  moradia: { label: "Moradia", emoji: "🏠", color: "bg-teal-100 text-teal-700" },
  restaurante: { label: "Restaurante", emoji: "🍽️", color: "bg-orange-100 text-orange-700" },
  pagamento_cartao: { label: "Pagamento Cartão", emoji: "💳", color: "bg-slate-100 text-slate-700" },
} as const;
