...
import { LayoutDashboard, PlusCircle, Settings, LogOut, PanelLeft, Wallet, Users, TrendingUp, CreditCard, BarChart3 } from "lucide-react";
      ...
      <SidebarInset>
        ...
        {isMobile && location === "/" && (
          <button
            ...
            className="fixed bottom-6 right-6 h-14 w-14 rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl transition-all flex items-center justify-center z-50 active:scale-95"
          >
